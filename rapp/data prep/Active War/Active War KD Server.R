...
data_table <- reactive({
  ...
  table_data <- switch(input$ref_select,
                       ...
                       "Active_War_Region_NonPlayer_Full_Join_Corleone" = Active_War_Region_NonPlayer_Full_Join_Corleone,
                       "Active_War_Region_NonPlayer_Full_Join_Cuneo" = Active_War_Region_NonPlayer_Full_Join_Cuneo,
                       "war_45_damage" = war_45_damage,
                       "war_45_suicides" = war_45_suicides,
