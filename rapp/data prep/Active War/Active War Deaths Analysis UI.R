Active_War_Deaths <- tabPanel(title = "Death Analysis", icon = icon('hospital'),
                              ...
                              h1("Total Percentage of Deaths Across Entire by Selected Played Daily", style = "color: #336699 ; font-weight: 600"),
                              p("Total Percentage of Deaths by Selected Played Daily"),
                              fluidRow(
